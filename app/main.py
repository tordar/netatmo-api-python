...
USERNAME= os.environ['USERNAME'],           #   Your netatmo account username
PASSWORD= os.environ['PASSWORD'] 

cred = {                           # You can hard code authentication information in the following lines
        "CLIENT_ID":  CLIENT_ID,
        "CLIENT_SECRET": CLIENT_SECRET,
        "USERNAME": USERNAME,           #   Your netatmo account username
        "PASSWORD": PASSWORD           #   Your netatmo account password
        }
...
def main():
    ...
    # This variable can also be hardcoded
    # SLEEPTIME = 5
    
    PATH = "/pictures/"
    # Path to where pictures should end up

    print("\nWelcome to Timelapser \nPictures will be uploaded with " + str(SLEEPTIME) + " seconds intervals\n")
    ...
    # source_input = source.get_input(['*.jpg'], fps=25, deflicker=10)
